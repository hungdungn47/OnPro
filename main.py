...
def get_params():
    ...
    parser.add_argument('--num_epochs', type=int, default=5, help='(default=%(default)s)')
    parser.add_argument('--initial_task', type=int, default=4, help='(default=%(default)s)')
    ...
    parser.add_argument('--class_per_task', type=int, default=2, help='(default=%(default)s)')

    # CLOOD
    parser.add_argument(
        '--use_clood', action='store_true',
        help="If true, use CLOOD in model"
    )
    parser.add_argument(
    ...
    parser.add_argument('--til', action='store_true', help='Task incremental learning')
    parser.add_argument(
    ...
    parser.add_argument('--clood_buffer_size', type=int, default=200, help='(default=%(default)s)')
